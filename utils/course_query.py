...
def extract_course_query(text):
    ...
    level_match = re.search(r"(100|200|300|400)\s*level", text)
    semester_match = re.search(r"(first|second)\s*semester", text)
...
def get_courses_for_query(query_info, course_data):
    ...
    # ✅ Only return first matching answer to avoid noisy response
